...
_addon.itemEffects[22424] = { -- Redemption Wristguards
    {
        type = _addon.EFFECT_TYPE.MOD_MANA_PER_5,
        value = 4,
    },
...
_addon.itemEffects[22427] = { -- Redemption Legguards
    {
        type = _addon.EFFECT_TYPE.MOD_MANA_PER_5,
        value = 8,
    },
...
_addon.itemEffects[22425] = { -- Redemption Tunic
    {
        type = _addon.EFFECT_TYPE.MOD_MANA_PER_5,
        value = 10,
    },
...
_addon.itemEffects[22426] = { -- Redemption Handguards
    {
        type = _addon.EFFECT_TYPE.MOD_MANA_PER_5,
        value = 8,
    },
...
_addon.itemEffects[22428] = { -- Redemption Headpiece
    {
        type = _addon.EFFECT_TYPE.MOD_MANA_PER_5,
        value = 8,
    },
...
_addon.itemEffects[22430] = { -- Redemption Boots
    {
        type = _addon.EFFECT_TYPE.MOD_MANA_PER_5,
        value = 5,
    },
...
_addon.itemEffects[22431] = { -- Redemption Girdle
    {
        type = _addon.EFFECT_TYPE.MOD_MANA_PER_5,
        value = 5,
    },
...
_addon.itemEffects[22429] = { -- Redemption Spaulders
    {
        type = _addon.EFFECT_TYPE.MOD_MANA_PER_5,
        value = 4,
    },
