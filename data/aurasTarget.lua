...
local acidSpit = {
    {
        ...
        value = -10,
        hasStacks = true,
        auraCategory = CONST.DEBUFF_CATEGORY.ARMOR_MAJOR
    }
}
...
local minorArmorDebuff = {
    {
        ...
        affectMask = CONST.SCHOOL_MASK.PHYSICAL,
        value = -5,
        auraCategory = CONST.DEBUFF_CATEGORY.ARMOR_MINOR
    }
}
...
_addon.aurasTarget = {
    ...
    [60431] = { -- Earth and Moon 1
        {
            ...
            value = 4,
            auraCategory = CONST.DEBUFF_CATEGORY.SPELL_DAMAGE
        }
    },
    ...
    [51726] = { -- Ebon Plague 1
        ...
        },
        {
            ...
            value = 30,
            auraCategory = CONST.DEBUFF_CATEGORY.DISEASE_DAMAGE
        }
    },
    [51734] = { -- Ebon Plague 2
        {
    ...
    [46856] = { -- Trauma 1
        {
            ...
            value = 15,
            auraCategory = CONST.DEBUFF_CATEGORY.BLEED_DAMAGE
        }
    },
    [46857] = { -- Trauma 2
        {
    ...
    [30069] = { -- Blood Frenzy 1
        {
            ...
            affectMask = CONST.SCHOOL_MASK.PHYSICAL,
            value = 2,
            auraCategory = CONST.DEBUFF_CATEGORY.PHYSICAL_DAMAGE
        }
    },
    ...
    [30708] = { -- Totem of Wrath
        {
            ...
            value = 3,
            auraCategory = CONST.DEBUFF_CATEGORY.CRIT_ALL
        }
    },
    ...
    [12579] = { -- Winter's Chill
        {
            ...
            hasStacks = true,
            value = 1,
            auraCategory = CONST.DEBUFF_CATEGORY.CRIT_SPELL
        }
    },
    ...
    [33196] = { -- Misery 1
        {
            ...
            affectMask = CONST.SCHOOL_MASK.ALL_SPELL,
            value = 1,
            auraCategory = CONST.DEBUFF_CATEGORY.HIT_SPELL
        }
    },
    [33197] = { -- Misery 2
        {
