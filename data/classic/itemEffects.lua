...
_addon.itemEffects = {
    ...
    [10659] = { -- Shard of the Splithooves
        {
            type = _addon.CONST.EFFECT_TYPE.MOD_MANA_PER_5,
            value = 5,
        },
    ...
    [209678] = { -- Mantle of the Thresher Slayer
        {
    ...
    [211502] = { -- Void-Touched Leather Gauntlets
        {
            type = _addon.CONST.EFFECT_TYPE.GLOBAL_FLAT_HIT_CHANCE,
            value = 1,
        },
    ...
    [210794] = { -- Shifting Silver Breastplate
        {
            type = _addon.CONST.EFFECT_TYPE.GLOBAL_FLAT_HIT_CHANCE,
            value = 1,
        },
    ...
    [210795] = { -- Extraplanar Spidersilk Boots
        {
            type = _addon.CONST.EFFECT_TYPE.GLOBAL_FLAT_HIT_CHANCE,
            value = 1,
        },
    ...
    [212580] = { -- Lorekeeper's Staff
        {
            type = _addon.CONST.EFFECT_TYPE.MOD_MANA_PER_5,
            value = 4,
        },
    },
    [212584] = { -- Advisor's Gnarled Staff
        {
            type = _addon.CONST.EFFECT_TYPE.MOD_MANA_PER_5,
            value = 4,
        },
