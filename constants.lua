...
_addon.EFFECT_TYPE = {
    ...
    JUDGEMENT_SPELL = 22,
    WEAPONMOD_FLAT_HIT_CHANCE = 23,
    SPELLMOD_EFFECT_PAST_FIRST = 25,
    SPELLMOD_GCD_MS = 26,
    TRIGGER_UPDATE = 27,
    SPELLMOD_PCT_EFFECT = 28,
    SPELLMOD_PCT_DAMAGE = 29,
    SPELLMOD_PCT_HEALING = 30, -- TODO: this only exists because of holy nova, hack for HN instead?
    SCHOOLMOD_PCT_DAMAGE = 31,
    PCT_HEALING = 32,
    SPELLMOD_ADD_TRIGGER_SPELL = 33,
    SCHOOLMOD_PCT_DAMAGE_VERSUS = 34,
    SCHOOLMOD_PCT_CRIT_DAMAGE_VERSUS = 35,
    SCHOOLMOD_FLAT_SPELLPOWER_VERSUS = 36,
